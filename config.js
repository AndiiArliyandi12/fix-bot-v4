...
global.sig = 'https://instagram.com/f' // ig
global.sgh = '_' // github
global.sgc = 'https://chat.whatsapp.com/KIxIgm9zFDSEppHGfRlKCY' // group whatsapp
global.sdc = '_' //discord
global.snh = 'https://nhentai.net/g/365296/' // my youtube channel
...
/*============== STAFF ==============*/
global.owner = [
  ['62XXXXXXXXXXX', '𝕭𝖔𝖙 • [A]ndii ∅༢࿔ྀ', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
